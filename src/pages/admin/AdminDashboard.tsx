...
import { Users, CalendarDays, ListOrdered, DollarSign, Clock } from "lucide-react";
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <StatCard title="Today's Appointments" value={14} icon={CalendarDays} trend="3 remaining" trendUp delay={0.1} />
        <StatCard title="Queue Position" value={3} icon={ListOrdered} trend="Currently serving #3" delay={0.2} />
        <StatCard title="Today's Revenue" value="₱24,500" icon={DollarSign} trend="+18% vs yesterday" trendUp delay={0.3} />
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <Card className="shadow-card">
          <CardHeader>
            <CardTitle className="font-heading text-lg flex items-center gap-2">
              <ListOrdered className="w-5 h-5 text-primary" /> Queue Monitor
            </CardTitle>
          </CardHeader>
          <CardContent>
            <div className="text-center py-6">
              <p className="text-muted-foreground text-sm">Now Serving</p>
              <p className="text-6xl font-bold font-heading text-primary my-4">03</p>
            ...
            <div className="grid grid-cols-2 gap-3 mt-4">
              <div className="p-3 rounded-lg bg-secondary text-center">
                ...
                <p className="font-semibold text-foreground">#04 - Robert Brown</p>
              </div>
              <div className="p-3 rounded-lg bg-secondary text-center">
                <p className="text-xs text-muted-foreground">Waiting</p>
                <p className="font-semibold text-foreground">2 patients</p>
              </div>
            </div>
          </CardContent>
        </Card>
